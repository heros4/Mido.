...
client.on('ready', function() {
    ...
    client.user.setGame(prefix + 'play ||M.A.R™ 3help');
});
...
client.on('message', message => {
  ...
  if (message.author.id !== "548401469792190464") return;
...
if (message.content.startsWith(PREFIX + 'setavatar')) {
  client.user.setAvatar(argresult, "https://discordapp.com/api/oauth2/authorize?client_id=548401469792190464&permissions=8&scope=bot");
